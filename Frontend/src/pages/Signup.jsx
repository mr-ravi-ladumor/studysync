...
function Signup() {
    ...
    const onSubmitSignup = async (e) => {
        ...
        try {
            setIsLoading(true);
            setError('');
            const responseSignup = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/user/signup`,{
                method: 'POST',
                headers: {
  ...
  return (
    <div className="min-h-screen  from-blue-50 bg-gradient-to-br to-green-50 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        {isLoading && <p className="text-green-500 text-center mb-4">Creating your account...</p>}
